 ...
 * Clase con el mapa que contiene los servicios json
 *
 */
...
import net.proyecto.tesis.agrario.json.JsonAnalisisdelLugar;

//se crea interace locations para la notificacio de cambio
public class MapaAnalisisdelLugar extends FragmentActivity  implements LocationListener{
    ...
    protected void onCreator(Bundle saveInstanceState){
        ...
        //vista del mapa
        setContentView(R.layout.mapaanalisisdelugarjson);
