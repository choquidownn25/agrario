...
/**
 * Created by choqu_000 on 08/10/2015.
 */
public class MapaQuery extends ActionBarActivity {
...
MapView mMapView;
    ...
    private void ShowCallout(Callout calloutView, Graphic graphic, Point mapPoint) {
        ...
        cityPopulation.append("Poblacion: ");
    ...
    private class QueryFeatureLayer extends AsyncTask<String, Void, FeatureResult> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(MapaQuery.this, "", "Please wait....query task is executing");
        }
