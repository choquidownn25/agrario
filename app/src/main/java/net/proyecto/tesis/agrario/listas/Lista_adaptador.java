package net.proyecto.tesis.agrario.listas;

/**
 * Created by choqu_000 on 06/04/2015.
 * Clase donde adantamos nuestra lista
 *
 */
...
public abstract class Lista_adaptador extends BaseAdapter {
     ...
     * @param contexto El contexto de la aplicaci�n
     * @param R_layout_IdView Layout con las views que formar� un elemento de la lista
