...
import net.proyecto.tesis.agrario.json.JsonLugarGeocode;
...
public class MapaJsonLugarGeocode extends FragmentActivity  {
    ...
    class ParserTask extends AsyncTask<String, Integer, List<HashMap<String,String>>>{
        ...
        protected List<HashMap<String,String>> doInBackground(String... jsonData) {
            ...
            JsonLugarGeocode parser = new JsonLugarGeocode();
            ...
            try{
                ...
                places = parser.analizar(jObject);
            }catch(Exception e){
